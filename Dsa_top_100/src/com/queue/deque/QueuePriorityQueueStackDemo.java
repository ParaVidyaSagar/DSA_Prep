...
public class QueuePriorityQueueStackDemo {
	public static void main(String[] args) {
		 ...
		 * Method	Removes element?	Return value if empty	Throws exception?	Use when…
		 * poll()   ✅ Yes                 null                 ❌ No                You're unsure if it's empty
		 * remove() ✅ Yes                  N/A                 ✅ Yes               You're sure it's not empty
		 * 
		 */
